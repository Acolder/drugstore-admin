<template>
  <div class="doctor-detail">
    ...
    <div class="form-wrapper clearfix">
      <div class="left">
        <el-form ref="doctorform" :model="doctor" label-width="120px" :rules="rules" class="form">
          <el-form-item label="姓名" prop="realname">
            <el-input v-model="doctor.realname"></el-input>
          </el-form-item>
          <el-form-item label="药师填写医院">
          ...
          <el-form-item label="数字签名">
            ...
            <el-form-item label="个人介绍" class="textarea-wrapper">
              <el-input type="textarea" v-model="doctor.personalinfo" :rows="personalinfo_rows"></el-input>
            </el-form-item>
            <el-form-item label="擅长治疗" class="textarea-wrapper">
...
export default {
  data() {
    ...
    return {
      ...
      titles: [{ code: 20, name: '药士' }, { code: 21, name: '药师' }, { code: 22, name: '主管药师' }, { code: 23, name: '副主任药师' }, { code: 24, name: '主任药师' }],
      ...
      rules: {
        realname: [{ required: true, message: '请输入药师姓名', trigger: 'blur' }],
        referhosname: [{ required: true, message: '请输入医院名称', trigger: 'blur' }],
  ...
  computed: {
    personalinfo_rows: function() {
      ...
      return Math.ceil(temp.length / 66);
    },
  ...
  methods: {
    getDoctorDetail(userid) {
      let url = '/api/hospitalManage/getpharmacistinfo';
      ajax.get(url, {
        ...
        if (res.status === 200 && result && result.code === 0) {
          ...
          if (!Number.isNaN(Number(this.doctor.hosid))) {
