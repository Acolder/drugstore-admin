<template>
  <div>
    <div class="search-wrapper">
      <el-form :inline="true" :model="requestData" size="small" ref="westdrug_query_form" label-width="100px">
        <el-form-item label="药品名称" prop="drugName">
          <el-input v-model="requestData.drugName" placeholder="药品名称"></el-input>
        </el-form-item>
        <el-form-item label="药品编号" prop="goodsNum">
          <el-input v-model="requestData.goodsNum" placeholder="药品编号"></el-input>
        </el-form-item>
        <el-form-item label="代码" prop="pyCode">
          <el-input v-model="requestData.pyCode" placeholder="代码"></el-input>
        </el-form-item>
  ...
  methods: {
    getColumns() {
      ...
      let columns = [
        ...
        { field: 'categoryname', title: '类别', width: 50, titleAlign: 'center', columnAlign: 'center', isResize: true },
        ...
        { field: 'goodsnorms', title: '规格', width: 80, titleAlign: 'center', columnAlign: 'center', isResize: true },
        { field: 'goodsorgin', title: '产地', width: 160, titleAlign: 'center', columnAlign: 'center', isResize: true },
        { field: 'unit', title: '单位', width: 50, titleAlign: 'center', columnAlign: 'center', isResize: true },
        { field: 'unitprice', title: '价格', width: 80, titleAlign: 'center', columnAlign: 'center', isResize: true },
        { field: 'medpack', title: '发药单位', width: 50, titleAlign: 'center', columnAlign: 'center', isResize: true },
        { field: 'medconvercof', title: '转换系数', width: 50, titleAlign: 'center', columnAlign: 'center', isResize: true },
    ...
    getDataList() {
      ...
      ajax.get(`/api/ordermanage/getwesterndocherbslist`, { params: request }).then((res) => {
    ...
    resetForm() {
      this.$refs['westdrug_query_form'].resetFields();
    ...
    disable(row) {
      ...
      this.$confirm('是否确定要' + title + '该西药？', '提示', {
