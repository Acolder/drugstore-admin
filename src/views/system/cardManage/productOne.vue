<template>
  <div>
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="药店来源">
              <el-select v-model="sellerFrom" placeholder="请选择药店来源(默认为全部)" filterable @change="changeActive">
    ...
    <div class="table-wrapper">
      ...
      row-hover-color="#eee" row-click-color="#edf7ff" :select-all="selectALL" :select-change="selectChange" :select-group-change="selectGroupChange"  @on-custom-comp="customCompFuncProduct"></v-table>
    </div>
  ...
  methods: {
    ...
    getColumns() {
      ...
      let columns = [
        ...
        { field: 'productName', title: '商品名称', width: 150, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
        ...
        { field: 'productSku', title: '商品sku', width: 80, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
        { field: 'isChecked', title: '审批状态', width: 80, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
        { field: 'productDosageForm', title: '剂型', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
        { field: 'productProducingPlace', title: '生产厂商', width: 180, titleAlign: 'center', columnAlign: 'left', isResize: true, overflowTitle: true },
        ...
        { field: 'productSalesVolume', title: '销量', width: 80, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
        ...
        { field: 'operation', title: '操作', width: 150, titleAlign: 'center', columnAlign: 'center', componentName: 'outNewList', isResize: true }
      ];
