<template>
  <div id="cardList">
    <div class="search-wrapper">
      <el-form :inline="true" :model="screenInfo" size="small" >
        <el-form-item label="话题名称">
          <el-input v-model.trim="screenInfo.name" placeholder="请输入话题名称" clearable></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <div class="toolbar-wrapper">
      <el-button-group>
        <el-button type="default" size="small" icon="el-icon-plus" @click="addClass">添加话题</el-button>
    ...
    <!--  新增、编辑  -->
    <el-dialog :title="title" :visible.sync="topicShow" :modal-append-to-body="false" :append-to-body="true" width="420px" @close="cancel" center>
      <el-form :model="formData" ref="addData" size="small" :rules="addrules" label-width="100px">
        <el-form-item label="话题名称:" prop="title" class="source" style="width:85%;margin-bottom: 18px;">
          <el-input v-model="formData.title"></el-input>
        </el-form-item>
        <el-form-item label="话题排序:" prop="sort" class="source" style="width:85%;margin-bottom: 18px;">
          <el-input v-model="formData.sort"></el-input>
        </el-form-item>
        <el-form-item label="是否显示:" prop="is_show" class="source" style="width:85%;margin-bottom: 18px;">
  ...
  data() {
    ...
    return {
      ...
      addrules: {
        ...
        is_show: [{ required: true, message: '请选择类别', trigger: 'blur' }],
      },
      title: '',  // 新增、编辑标题
    };
  },
  computed: {
    columns() {
      ...
      let columns = [
        ...
        { field: 'title', title: '话题名称', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
