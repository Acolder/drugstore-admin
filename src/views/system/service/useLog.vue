<template>
  <div>
    ...
    <div class="title">
        <div class="mac"><span>Mac编码：{{this.$route.query.mac}}</span></div>
        <div class="size"><span>货品型号：{{this.$route.query.model === 0 ?  '基础版' : '皮套版'}}</span></div>
        <div class="time"><span>创建时间：{{this.$route.query.created_time}}</span></div>
    </div>
   ...
   <!-- 设备使用详情 -->
    <el-dialog
      ...
      <el-row>
        <el-col :span="24" class="col-wrap">
          <span>用户账号：</span>
          <span class="rights">{{detailData.borrow_account || '-'}}</span>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24" class="col-wrap">
          <span>联系方式：</span>
          <span class="rights">{{detailData.consignee_phone || '-'}}</span>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="24" class="col-wrap">
...
export default {
  ...
  methods: {
    getColumns() {
      ...
      { field: 'give', title: '设备去处', width: 160, titleAlign: 'center', columnAlign: 'center', isResize: true },
      { field: 'borrow_account', title: '用户账号', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true },
      { field: 'consignee_phone', title: '联系方式', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true },
      { field: 'borrow_days', title: '租借时间(天)', width: 80, titleAlign: 'center', columnAlign: 'center', isResize: true },
      { field: 'order_status', title: '当前状态', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true },
      { field: 'created_time', title: '订单提交时间', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true },
      { field: 'start_time', title: '开始时间', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true },
      { field: 'end_time', title: '到期时间', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true },
      { field: 'back_time', title: '退还时间', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true },
      { field: 'back_affim_time', title: '收到设备时间', width: 80, titleAlign: 'center', columnAlign: 'center', isResize: true },
      ...
      { field: 'order_money', title: '成交金额数', width: 60, titleAlign: 'center', columnAlign: 'center', isResize: true },
