<template>
  <div>
    ...
    <el-dialog title="日志详情" :visible.sync="logPop" :modal-append-to-body="false" width="50%" center>
      ...
      <div class="display-box">
        <label class="txt">客户端: </label>
        <label class="box-flex">{{detailData.clientname}}</label>
      </div>
      <div class="display-box">
...
export default {
  ...
  methods: {
    getColumns() {
      ...
      { field: 'clientname', title: '客户端', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true },
