        ...
        <el-row>
          ...
          <!-- <el-col :span="8">
            <el-form-item label="药品来源">
              <el-select v-model="durgfrom" placeholder="请选择药品来源" clearable>
  ...
  methods: {
    ...
    getColumns() {
      ...
      let columns = [
        ...
        { field: 'productSku', title: '商品sku', width: 100, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
        { field: 'isChecked', title: '审批状态', width: 80, titleAlign: 'center', columnAlign: 'center', isResize: true },
        { field: 'productDosageForm', title: '剂型', width: 60, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
        ...
        { field: 'productMarkprice', title: '商品市场价', width: 80, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
        { field: 'productStocks', title: '商家价格', width: 80, titleAlign: 'center', columnAlign: 'center', isResize: true, overflowTitle: true },
        ...
        // { field: 'operation', title: '操作', width: 200, titleAlign: 'center', columnAlign: 'center', componentName: 'table-operation-druglist', isResize: true }
      ];
      for (let i = 0; i < columns.length; i++) {
        ...
        if (item.field === 'productStocks') {
          item.formatter = function (rowData, rowIndex, pagingIndex, field) {
            let value = rowData[field];
            if (value) {
              let v = value[0].productPrice;
