      ...
      <el-row>
        ...
        <el-col :span="24">
          <el-form-item prop="content" class="body">
            ...
            <ueditor :id="'content_ueditor'" ref="content_ueditor" class="body_content"></ueditor>
          </el-form-item>
        </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      let param = this.form;
      ajax.post(`api/vip/explain/edit`, param).then(res => {
    ...
    getTable() {
      ajax.get(`api/vip/explain/get`).then(res => {
        if (res.status === 200 && res.data.code === 0) {
